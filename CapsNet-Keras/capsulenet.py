...
def train(model, train_directory, valid_directory, args):
    """
    ...
    model.fit_generator(generator=train_generator(train_directory, args.batch_size, args.shift_fraction),
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_address', type=str, default='synthetic_plates/output/yolo/train/glyphs', help='The address of train dataset')
    parser.add_argument('--valid_address', type=str, default='synthetic_plates/output/yolo/valid/glyphs', help='The address of valid dataset')
    parser.add_argument('--test_address', type=str, default='synthetic_plates/output/yolo/test/glyphs', help='The address of test dataset')
